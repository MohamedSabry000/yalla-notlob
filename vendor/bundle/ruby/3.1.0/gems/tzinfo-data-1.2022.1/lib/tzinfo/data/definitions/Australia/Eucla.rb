      ...
      module Australia
        module Eucla
          ...
          timezone 'Australia/Eucla' do |tz|
            ...
            tz.transition 1916, 12, :o2, -1672555500, 77479335, 32
            tz.transition 1917, 3, :o1, -1665384300, 77481991, 32
            tz.transition 1941, 12, :o2, -883637100, 77771527, 32
            tz.transition 1942, 3, :o1, -876120300, 77774311, 32
            tz.transition 1942, 9, :o2, -860395500, 77780135, 32
            tz.transition 1943, 3, :o1, -844670700, 77785959, 32
